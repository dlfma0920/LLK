...
<script>
   function myPage() {
      window.location.href = "myPage.do?id=${sessionScope.session.id}";
...
<body id="page-top">
   ...
   <section class="bg-primary text-white mb-0" id="submit">
      <div class="container">
         <form action="userModifyTry.do" method="post" accept-charset="UTF-8">
