...
<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
>>>>>>> branch 'master' of https://github.com/dlfma0920/LLK.git
<!DOCTYPE html>
<html lang="en">
<<<<<<< HEAD
  <head>
...
=======
<!-- Bootstrap core CSS -->
<link href="https://fonts.googleapis.com/css?family=Do+Hyeon|Gothic+A1:800" rel="stylesheet">
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand js-scroll-trigger" href="#page-top">잡 서포팅
				시스템</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						...
						href="#portfolio">기업정보</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
						href="#about">자유게시판</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
				...
				<c:forEach var="job" items="${list}">
					<div class="col-md-6 col-lg-4">
						<a class="portfolio-item d-block mx-auto" href="#${job.ccode}">
							...
							<div class = "text-center"> <img class="img-responsive"
							src="${pageContext.request.contextPath}/resources/img/tps.png"
							alt="">
							<hr class="style-one">
							<p>
								<c:out value="${job.ctitle}" />
